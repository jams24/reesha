...
export default function Hero() {
  return (
    <section className="border-b border-neutral-200">
      <div className="container-x py-12 sm:py-20 lg:py-28 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        <div className="lg:col-span-7 fade-in order-2 lg:order-1">
          <p className="eyebrow">Est. Osogbo · Nationwide delivery</p>
          <h1 className="mt-4 sm:mt-6 text-[2.5rem] leading-[1.05] sm:text-6xl lg:text-7xl font-serif tracking-tight">
            Curated thrift.<br />
            <span className="italic">Imported wears.</span>
          </h1>
          <p className="mt-5 sm:mt-8 text-sm sm:text-base text-neutral-600 max-w-xl leading-relaxed">
          ...
          <div className="mt-8 sm:mt-10 flex flex-wrap gap-3">
            <Link to="/shop" className="btn-primary flex-1 sm:flex-none">Shop the collection</Link>
            <Link to="/about" className="btn-outline flex-1 sm:flex-none">Our story</Link>
          </div>
        </div>
