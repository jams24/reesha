    ...
    <div>
      <section className="border-b border-neutral-200">
        <div className="container-x py-20 sm:py-28 max-w-3xl">
          ...
          <h1 className="mt-4 text-5xl sm:text-6xl font-serif leading-[1.05] tracking-tight">
      ...
      <section className="container-x py-20 grid md:grid-cols-3 gap-8">
        {[
          ...
          <div key={v.title} className="border-t border-ink pt-6">
            ...
            <p className="mt-3 text-sm text-neutral-600 leading-relaxed">{v.body}</p>
          </div>
        ))}
      </section>

      <section className="bg-ink text-paper">
        <div className="container-x py-20 grid lg:grid-cols-2 gap-10 items-start">
          <div>
            <p className="text-[11px] uppercase tracking-widest2 text-neutral-400">Get in touch</p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-8 inline-flex items-center gap-2 bg-paper text-ink px-8 py-3 text-xs uppercase tracking-widest2 font-medium hover:bg-neutral-200 transition"
            >
          ...
          <dl className="space-y-6">
            <div className="border-t border-neutral-700 pt-6">
              <dt className="text-[11px] uppercase tracking-widest2 text-neutral-400">Phone / WhatsApp</dt>
              <dd className="mt-2 text-lg"><a href="tel:+2348161518807" className="hover:text-neutral-300">+234 816 151 8807</a></dd>
            </div>
            <div className="border-t border-neutral-700 pt-6">
              <dt className="text-[11px] uppercase tracking-widest2 text-neutral-400">Email</dt>
            ...
            <div className="border-t border-neutral-700 pt-6">
              <dt className="text-[11px] uppercase tracking-widest2 text-neutral-400">Location</dt>
              <dd className="mt-2 text-lg">Osogbo, Osun State</dd>
              <dd className="text-sm text-neutral-400 mt-1">We deliver nationwide across Nigeria.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <section className="container-x py-20">
        ...
        <div className="mt-8 aspect-[16/7] bg-neutral-100 overflow-hidden">
          <iframe
            title="Osogbo map"
